...
local syntax = {
    ...
    Macro = { fg = challenger_deeper.yellow },
...
local plugin_syntax = {
    ...
    VistaScope = { fg = challenger_deeper.purple, bold = true },
    ...
    DiagnosticError                          = { bg = challenger_deeper.error_bg, fg = challenger_deeper.red },
    DiagnosticWarn                           = { bg = challenger_deeper.warning_bg, fg = challenger_deeper.dark_yellow }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
    DiagnosticInfo                           = { bg = challenger_deeper.info_bg, fg = challenger_deeper.fg },             -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
    DiagnosticHint                           = { bg = challenger_deeper.hint_bg, fg = challenger_deeper.blue },           -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
    DiagnosticUnderlineError                 = {
        fg = challenger_deeper.red,
        sp = challenger_deeper.dark_red,
        underline = true
    },
